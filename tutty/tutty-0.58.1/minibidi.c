...
void flipThisRun(bidi_char * from, unsigned char *level, int max,
		 int count);
...
#define TYPETONAME(X) { X , #X }
	TYPETONAME(L),
	    ...
	    TYPETONAME(NSM),
	    TYPETONAME(BN),
	    TYPETONAME(B), TYPETONAME(S), TYPETONAME(WS), TYPETONAME(ON),
#undef TYPETONAME
    };
    int i;
