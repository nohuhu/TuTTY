...
#define ATTR_SELECTED 0x02000000UL
...
struct config_tag {
    ...
    int ser_redials;
    int ser_redialtimeout;
    int ser_dialtimeout;
    int ser_print_when_dialing;
    char ser_modem_init[20];
    char ser_modem_dial_tone[20];
    char ser_modem_dial_pulse[20];
    char ser_modem_hangup[20];
    char ser_modem_commandmode[20];
    char ser_modem_ok[20];
    char ser_modem_error[20];
    char ser_modem_busy[20];
