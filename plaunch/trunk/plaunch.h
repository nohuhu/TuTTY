...
#define IDM_SESSION_MAX		0x2fff

#define	IDM_RUNNING_BASE	0x3000
#define	IDM_RUNNING_MAX		0x5000
...
#define HOTKEY_DEFAULT_LAUNCHBOX    MAKELPARAM(MOD_WIN, 'P')
#define	HOTKEY_DEFAULT_WINDOWLIST   MAKELPARAM(MOD_WIN, 'W')
#define HOTKEY_DEFAULT_HIDEWINDOW   MAKELPARAM(MOD_WIN, 'H')
#define	HOTKEY_DEFAULT_CYCLEWINDOW  MAKELPARAM(MOD_WIN, 'Z')
